...
A higher fixed acidity does lead to a lower PH. PH and quality are hardly
correlated. My conclusion is that as long as PH moves somewhere from 3 to 3.8,
it is ok.
...
ggplot(data = RW, aes(x=density, y=fixed.acidity)) + geom_point(alpha=0.2, colour="blue") + geom_smooth()
ggplot(data = RW, aes(x=density, y=citric.acid)) + geom_point(alpha=0.2, colour="red") + geom_smooth()
ggplot(data = RW, aes(x=density, y=residual.sugar)) + geom_point(alpha=0.2, colour="green") + geom_smooth()
ggplot(data = RW, aes(x=density, y=alcohol)) + geom_point(alpha=0.2, colour="purple") + geom_smooth()
