...
qplot(data=RW, x=fixed.acidity)

qplot(data=RW, x=volatile.acidity)

qplot(data=RW, x=citric.acid)

qplot(data=RW, x=residual.sugar)

qplot(data=RW, x=chlorides)

qplot(data=RW, x=free.sulfur.dioxide)

qplot(data=RW, x=total.sulfur.dioxide)

qplot(data=RW, x=density)

qplot(data=RW, x=pH)

qplot(data=RW, x=sulphates)

qplot(data=RW, x=alcohol)
